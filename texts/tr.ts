export default {
  ...
  // footer
  footerHeader: 'Ukrayna için Omuz Omuza—Rus işgaline karşı savaşmaya ve sonuçlarının üstesinden gelmeye yardımcı olan güvenilir kuruluşların bir toplayıcısıdır.',
